...
import { Plus, Bot, ChevronRight, Save, Trash2 } from 'lucide-react';
    ...
    <div className="flex-1 flex h-full bg-[var(--bg-primary)] text-[var(--text-main)] font-inter">
      ...
      <div className="w-80 border-r border-[var(--border)] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-2 space-y-1">
              {agents.map(agent => (
                  <div key={agent.id} className="group p-3 rounded-lg hover:bg-[var(--bg-secondary)] border border-transparent hover:border-[var(--border)] cursor-pointer transition-all">
